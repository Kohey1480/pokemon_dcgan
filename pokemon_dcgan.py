...
class DCGAN():
    def __init__(self, img_size=(64,64), img_channels = 3, ans_path = "./poke64/", save_path = "./newPokemon", save_name = "pokemon" ):
        # 画像データ用の入力データサイズ
...
if __name__ == '__main__':
    gan = DCGAN(ans_path = "./poke64/", save_path = "./newPokemon/", save_name = "pokemon")
    gan.Generator()
    gan.Discriminator()
    gan.Combined()
    gan.train(epochs = 1000000)